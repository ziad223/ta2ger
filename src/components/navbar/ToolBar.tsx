...
const ToolBar = () => {
  ...
  return (
    <div className='bg-[#09adce] py-2 relative  z-50'>
      <Container>
      ...
      >
        ...
        {/* Menu Links - نفس الروابط الموجودة في الشاشات الكبيرة مع إمكانية التمرير */}
        <div className="h-[calc(100%-80px)] overflow-auto">
          <ul className="flex flex-col gap-2 px-5 py-6 text-black text-sm">
            {/* قسم الإدارة */}
            <li className="font-semibold text-[#09adce] border-b pb-2 mb-2">الإدارة</li>
            <li>
              <Link
            ...
            {/* قسم إعدادات الرسائل */}
            <li className="font-semibold text-[#09adce] border-b pb-2 mb-2 mt-4">إعدادات الرسائل</li>
            <li>
              <Link
                onClick={() => setShowMenu(false)}
            ...
            {/* قسم المستخدم */}
            <li className="font-semibold text-[#09adce] border-b pb-2 mb-2 mt-4">المستخدم</li>
            <li>
              <Link
                onClick={() => setShowMenu(false)}
                to="/program-additions"
                className="block px-4 py-2 rounded hover:bg-gray-100 transition-colors"
              >
                دليل المستخدم
              </Link>
            ...
            <li>
              <button
                ...
                className="block w-full text-right px-4 py-2 rounded hover:bg-gray-100 transition-colors text-red-600"
              >
                تسجيل الخروج
              </button>
            </li>
