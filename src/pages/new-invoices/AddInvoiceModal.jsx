...
const AddInvoiceModal = ({ isOpen, onClose, onSave, clients = [] }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-[99999] px-4 sm:px-6">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl p-4 sm:p-6 overflow-y-auto max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block mb-1 font-medium text-sm">رقم الفاتورة</label>
              <input
                type="number"
                name="id"
                value={form.id}
            ...
            <div>
              <label className="block mb-1 font-medium text-sm">العميل</label>
              <CustomSelect
            ...
            <div>
              <label className="block mb-1 font-medium text-sm">تاريخ الفاتورة</label>
              <input
                type="date"
                name="date"
                value={form.date}
            ...
            <div>
              <label className="block mb-1 font-medium text-sm">مبلغ الفاتورة</label>
              <input
                type="number"
                name="amount"
                value={form.amount}
            ...
            <div>
              <label className="block mb-1 font-medium text-sm">الضريبة</label>
              <input
                type="number"
                name="tax"
                value={form.tax}
            ...
            <div>
              <label className="block mb-1 font-medium text-sm">المبلغ الإجمالي</label>
              <input
                type="number"
                name="total"
                value={form.total}
            ...
            <div>
              <label className="block mb-1 font-medium text-sm">المتبقي</label>
              <input
                type="number"
                name="remaining"
            ...
            <div>
              <label className="block mb-1 font-medium text-sm">حالة الفاتورة</label>
              <CustomSelect
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-2 mt-4">
            <button
              type="button"
              onClick={onClose}
              className="w-full sm:w-auto px-4 py-2 bg-gray-300 rounded text-sm"
            >
              إلغاء
            </button>
            <button
